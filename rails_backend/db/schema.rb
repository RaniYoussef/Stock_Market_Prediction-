...
ActiveRecord::Schema[8.0].define(version: 2025_07_01_133448) do
  ...
  create_table "predictions", force: :cascade do |t|
    ...
    t.float "predicted_open_price"
    t.integer "predicted_next_move"
    t.float "actual_open_price"
    t.datetime "predicted_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_id"], name: "index_predictions_on_company_id"
  end
  ...
  add_foreign_key "predictions", "companies"
